...
namespace DoctrineProxies\__CG__\App\Domain\Users;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \App\Domain\Users\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'email', 'password', 'remember_token', 'api_token', 'created_at', 'updated_at', 'emails'];
        }
     ...
     * {@inheritDoc}
     */
    public function addEmail(\App\Domain\Email\Email $email)
    {
